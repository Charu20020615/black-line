...
export default function Accessories() {
  ...
  const fetchProducts = async () => {
    try {
      setLoading(true);
      const data = await getProducts('accessories');
      setProducts(data);
    } catch (error) {
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-[#d4af37] font-sans">
      ...
      <section className="py-16 px-12">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold mb-4 gold-text">Accessories</h1>
          <p className="text-gray-400 max-w-2xl mx-auto text-lg">
            Complete your look with our premium selection of accessories.
          </p>
        </div>
