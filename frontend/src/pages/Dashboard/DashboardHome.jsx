      ...
      <section className="py-16 border-t border-[#1a1a1a]">
        ...
        <div className="px-12">
          <div className="columns-1 md:columns-2 lg:columns-3 gap-6 space-y-6">
            {[
              {img: '/Images/gallery1.png', alt: 'Gallery Image 1', span: 'md:col-span-1'},
              {img: '/Images/gallery2.png', alt: 'Gallery Image 2', span: 'md:col-span-1'},
              {img: '/Images/gallery3.png', alt: 'Gallery Image 3', span: 'md:col-span-1'},
              {img: '/Images/gallery4.png', alt: 'Gallery Image 4', span: 'md:col-span-1'},
              {img: '/Images/gallery5.png', alt: 'Gallery Image 5', span: 'md:col-span-1'},
              {img: '/Images/gallery6.png', alt: 'Gallery Image 6', span: 'md:col-span-1'},
            ].map((item, index) => (
              <div key={index} className="break-inside-avoid mb-6 group cursor-pointer">
